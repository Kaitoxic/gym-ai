$path = 'C:\Users\cleme\Documents\AI-ClaudeOpus\projets\gym-coach-app\src\routes\exercises.ts'
$content = @'
...
// GET /exercises — paginated, filterable, public
...
// GET /exercises/:slug — single exercise, public
...
Write-Host "Written exercises.ts"
